...
**DB:** `docs/designs/database/US-005-db-design.md`, `US-005-entity-model.md` (amended 2026-08-31 with `refresh_tokens`, resolved OD-9)
**Impact analysis:** `docs/impact-analysis/US-005-impact-analysis.md`
...
Three findings surfaced after this plan was first reviewed (`docs/reviews/plans/US-005-plan-review.md`), all folded in below rather than tracked separately:
...
Per `docs/impact-analysis/US-005-impact-analysis.md`'s survey (not re-derived here):

...
**DB:** `docs/designs/database/US-006-db-design.md`, `US-006-entity-model.md`
**Impact analysis:** `docs/impact-analysis/US-006-impact-analysis.md`
...
Per `docs/impact-analysis/US-006-impact-analysis.md`'s survey (not re-derived here):

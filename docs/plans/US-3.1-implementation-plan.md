# Implementation Plan: Manage Users (US-3.1 / spec US-3.1)

**Spec:** docs/specifications/US-3.1-spec.md
**API design:** docs/designs/api/US-3.1-openapi.yaml, US-3.1-api-design.md
**DB design:** docs/designs/database/US-3.1-db-design.md, US-3.1-entity-model.md
**Impact analysis:** docs/impact-analysis/US-3.1-impact-analysis.md
...
| `app/modules/admin_users/models.py` | `InvitationToken` (new table, per `US-3.1-entity-model.md`). |
...
| `app/modules/admin_users/router.py` | 7 routes per `US-3.1-openapi.yaml`; imports `require_scope` from `app.modules.roles.dependencies`. |
...
| `docs/designs/api/US-3.1-openapi.yaml` | `UpdateUserRequest` gains required `reason` (Architectural Change #4) — design-doc amendment, not application code. |

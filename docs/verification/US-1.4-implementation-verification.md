...
|---|---|---|---|---|---|
| `POST /v1/account/deactivate` | `test_deactivate_no_token_returns_401` | `test_deactivate_expired_token_returns_401` | `test_deactivate_malformed_token_returns_401` | N/A — self-service only, no role/scope gating on this endpoint (documented in `docs/tests/US-1.4-ac-test-matrix.md`) | `test_deactivate_revoked_session_token_returns_401` |

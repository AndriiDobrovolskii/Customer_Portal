...
**Spec Reviewed:** docs/specifications/US-1.2-spec.md
**Story ID:** US-1.2
**Reviewed:** 2026-08-15
...
- **Case-insensitive email matching on resend (FR-7, FR-8)** — Not addressed by any AC; the spec now requires case-insensitive lookup, consistent with the precedent set for registration in US-1.1. Disclosed in Clarification #3.

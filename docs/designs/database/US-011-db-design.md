# DB Design: Manage Users (US-3.1 / spec US-011)

**Source spec:** docs/specifications/US-011-manage-users-spec.md (revised 2026-09-02; Data Model Notes: `users.status`, `invitation_tokens`, `admin_audit_log`)
**Spec review:** docs/reviews/specifications/US-011-spec-review.md (Pass with Issues, accepted 2026-09-02)
**API design:** docs/designs/api/US-011-openapi.yaml

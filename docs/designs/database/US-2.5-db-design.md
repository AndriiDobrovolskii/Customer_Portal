# DB Design: Multi-Factor Authentication / TOTP (US-2.5 / spec US-2.5)

**Source spec:** docs/specifications/US-2.5-spec.md (Data Model Notes: `users.mfa_enabled`, `users.mfa_secret_encrypted`, `users.mfa_activated_at`, `mfa_recovery_codes`, Valkey replay key, `auth_audit_log` event names)
**Spec review:** docs/reviews/specifications/US-2.5-spec-review.md (Pass with Issues, resolved 2026-09-01)
**API design:** docs/designs/api/US-2.5-openapi.yaml

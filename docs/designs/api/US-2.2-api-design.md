...
**Contract:** `US-2.2-openapi.yaml`
**Spec:** `docs/specifications/US-2.2-spec.md` (Pass with Issues, accepted 2026-08-31 — `docs/reviews/specifications/US-2.2-spec-review.md`)

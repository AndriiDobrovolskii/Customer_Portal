...
**Contract:** `US-2.6-openapi.yaml`
**Spec:** `docs/specifications/US-2.6-spec.md` (Pass with Issues, resolved 2026-09-02 — `docs/reviews/specifications/US-2.6-spec-review.md`)
...
Logout of the current session and logout-everywhere (US-2.2, unchanged); admin-facing visibility into another user's sessions (not currently required; would need its own permission and audit story) — unchanged from `docs/specifications/US-2.6-spec.md#out-of-scope`.

# Traceability Matrix: Active Session Management (US-2.6 / spec US-2.6)

**Spec:** `docs/specifications/US-2.6-spec.md`
**Task breakdown:** `docs/plans/US-2.6-task-breakdown.md` (T7 unit, T8 integration — test code itself deferred to IMPLEMENTATION, matrix only at this stage, same sequencing as US-2.1–US-2.5/US-3.2)
**Written:** 2026-09-02

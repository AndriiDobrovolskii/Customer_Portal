...
**Source:** `docs/specifications/US-1.1-spec.md` FR-2. Reused verbatim for admin-created accounts (`US-3.1-manage-users-spec.md` FR-6) and for a profile email change (`US-1.3-update-profile-spec.md` FR-10).
...
**Source:** `docs/specifications/US-1.2-spec.md` FR-5, FR-10.

---

## BR-003

Password hashing is Argon2id, project-wide — login verification, registration, password reset, MFA recovery codes. This was a live inconsistency (the stories' Assumptions & Defaults tables specified Argon2id deliberately, e.g. for its timing-safe/GPU-resistant properties, while `AGENTS.md`/`docs/ARCHITECTURE.md` and the already-shipped US-1.1 implementation used bcrypt) resolved on 2026-08-29 in favor of Argon2id — see `docs/decisions/password-hashing-algorithm.md`. `AGENTS.md`, `docs/ARCHITECTURE.md`, `pyproject.toml`, `app/core/security.py`, `app/core/config.py`, `.env.example`, and the affected integration test were all updated to match.

**Source:** `docs/stories/US-2.1-login.md` Assumptions & Defaults #6; `docs/specifications/US-2.1-spec.md` FR-3, `US-2.4-password-reset-spec.md` FR-2, `US-2.5-mfa-totp-spec.md` FR-2; `AGENTS.md` §2, §7 (updated); `docs/decisions/password-hashing-algorithm.md`.
...
**Source:** `docs/specifications/US-1.1-spec.md` FR-6; `US-2.1-login-spec.md` NFR.
...
**Source:** `docs/specifications/US-2.1-spec.md` FR-3, NFR; `US-1.2-verify-email-spec.md` FR-8; `US-2.4-password-reset-spec.md` FR-3.
...
**Source:** `docs/specifications/US-1.4-spec.md` FR-1, FR-6, FR-7, FR-10; `US-3.1-manage-users-spec.md` FR-13.
...
**Source:** `docs/specifications/US-1.4-spec.md` FR-8, FR-9.
...
**Source:** `docs/specifications/US-2.3-spec.md` FR-1, FR-2.
...
**Source:** `docs/specifications/US-2.2-spec.md` FR-1, FR-2, FR-4.
...
**Source:** `docs/specifications/US-3.2-spec.md`, Background.
...
**Source:** `docs/specifications/US-3.2-spec.md` FR-2, NFR.
...
**Source:** `docs/specifications/US-3.1-spec.md` FR-15, FR-16; `US-3.2-manage-roles-spec.md` FR-5, FR-6, FR-7.
...
**Source:** `docs/specifications/US-2.5-spec.md` FR-6.
...
**Source:** `docs/specifications/US-4.2-spec.md` FR-3, FR-5.
...
**Source:** `docs/specifications/US-4.1-spec.md` FR-9.

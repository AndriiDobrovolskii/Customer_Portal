# Impact Analysis: Password Reset (US-2.4 / spec US-008)
...
**DB design:** `docs/designs/database/US-008-db-design.md`, `docs/designs/database/US-008-entity-model.md`
**Written:** 2026-09-01
...
| Schemas | `app/modules/users/schemas.py` | New `PasswordResetRequestRequest`, `PasswordResetRequestResponse`, `PasswordResetConfirmRequest` (per `US-008-openapi.yaml`). |

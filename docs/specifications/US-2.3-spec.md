...
**Status:** Draft (SPEC_REVIEW Pass with Issues, accepted by user 2026-09-01 — see `docs/reviews/specifications/US-2.3-spec-review.md`; all 3 findings resolved same-day)

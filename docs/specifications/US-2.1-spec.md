...
**Status:** Draft (spec-review pending re-run against this revision; prior review at `docs/reviews/specifications/US-2.1-spec-review.md` applies to the 2026-08-22 version)
...
**Derived from:** LI-AC4 (403 branches); resolved OD-10 (reactivation branch — assigned to this story by `US-1.4-deactivate-account-spec.md` FR-8 / `docs/stories/US-1.4-deactivate-account.md` DA-AC8, not stated by LI-AC4's own text); audit behavior per resolved OD-4

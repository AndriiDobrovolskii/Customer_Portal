...
**Source:** docs/specifications/US-1.1 Register User.md
**Story ID:** US-1.1
...
The following points were left undefined by the source story (US-1.1) and were resolved by explicit stakeholder decision on 2026-08-15, rather than derived from AC text. They supersede the prior "Open Questions" section.

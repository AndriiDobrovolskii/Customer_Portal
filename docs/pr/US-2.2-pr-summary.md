...
- Implements `POST /v1/auth/logout` and `POST /v1/auth/logout-all` per `docs/specifications/US-2.2-spec.md` (spec review: Pass with Issues, accepted): single-device and account-wide session revocation, idempotent repeat logout, and a shared unauthenticated `401` envelope — no new module, no new error class, no new Valkey surface.
...
**Linked docs:** spec `docs/specifications/US-2.2-spec.md` · open decisions `docs/decisions/US-2.2-open-decisions.md` (6 resolved) · plan `docs/plans/US-2.2-implementation-plan.md` · task breakdown `docs/plans/US-2.2-task-breakdown.md`.
...
docs/designs/api/US-2.2-api-design.md                      (new)
docs/designs/api/US-2.2-openapi.yaml                        (new)
docs/designs/database/US-2.2-db-design.md                   (new)
docs/designs/database/US-2.2-entity-model.md                 (new)
docs/evidence/.gitignore                                   (fixed)
docs/evidence/US-2.2-clarification-report.md                (new)
docs/impact-analysis/US-2.2-impact-analysis.md               (new)
docs/plans/US-2.2-implementation-plan.md                     (new)
docs/plans/US-2.2-task-breakdown.md                          (new)
docs/reviews/reconciliation/US-2.2-reconciliation.md           (new)
docs/reviews/plans/US-2.2-plan-review.md                      (new)
docs/reviews/reconciliation/.gitignore                       (fixed)
docs/reviews/security/.gitignore                             (fixed)
docs/reviews/specifications/US-2.2-spec-review.md
docs/reviews/security/US-2.2-security-review.md                       (new)
docs/specifications/US-2.2-spec.md
docs/tests/US-2.2-ac-test-matrix.md                      (new)
docs/verification/US-2.2-implementation-verification.md               (new)
